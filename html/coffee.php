...
<head>
   ...
   <title class="title">Купить турецкий кофе с доставкой на дом</title>
   <meta name="yandex-verification" content="916e2a295ce04105" />
   <meta class="description" name="description"
      content="Интернет-магазин турецких товаров, Кофе, сладости, чай. Турция у вас дома.">
...
<div class="catalog__container">
  <h1 class="category">Легендарный, тот самый кофе из Турции!</h1>
