...
<script>
   ...
   fbq('init', '1010378836204620');
   fbq('track', 'PageView');
   </script>
   <noscript><img height="1" width="1" style="display:none"
   src="https://www.facebook.com/tr?id=1010378836204620&ev=PageView&noscript=1"
   /></noscript>
               ...
               <div class="container">
                  <nav class="header__nav">
                     <ul class="header__menu">
                        <li class="header__menu-link"><a href="index.php">Лукум</a></li>
                        <li class="header__menu-link"><a href="pahlava.php">Пахлава</a></li>
                     ...
                     <div class="header__nav-item">
                        <div class="header__nav-btn-menu-wrap">
                           ...
                           <div class="header__nav__dropdown-on">
                              ...
                              <a href="pahlava.php" class="header__nav-dropdown-link">Пахлава</a>
